...
Assoc =  1 if a household member is in any community organizations   
Educ = Years of education of well user  
...
er_7 <- mean((df$ffitted>0.5 & df$switch==0) | (df$ffitted<0.5 & df$switch==1))
er_7
...
## What @Gelman2007 did not discuss (explicitly) in their chapter about linear regression but was mentioned in the lectures or the book of @Field2012
